...
void cheapest();
void fastest();
void cheapestRoundTrip();
void fastestRoundTrip();
void addStation();
...
void displayFunctions()
{
    ...
    cout << "6. Cheapest round-trip (there and back)" << endl;
    cout << "7. Fastest round-trip (there and back)";
...
C:
    ...
    cout << "Would you like to see an alternate route based on minimum distance? (y/n): ";
    char showAlt = 'n';
    cin >> showAlt;
    clearBuffer();
    if (showAlt == 'y' || showAlt == 'Y')
    {
        system("cls");
        cout << "Alternate route (shortest by distance):" << endl
             << endl;
...
C:
    ...
    cout << "Would you like to see an alternate route based on minimum cost? (y/n): ";
    char showAlt = 'n';
    cin >> showAlt;
    clearBuffer();
    if (showAlt == 'y' || showAlt == 'Y')
    {
        system("cls");
        cout << "Alternate route (cheapest by cost):" << endl
             << endl;
        l.cheapestRoute(src, dest);
        cout << endl
             << endl;
...
void cheapestRoundTrip()
{
    ...
    cin.ignore();
B:
    cout << "Round-trip (Cheapest): Enter starting station ('back' to go back): ";
    string org;
    getline(cin, src);
    org = src;
    bool digit = true;
...
C:
    cout << "Round-trip (Cheapest): Enter destination station ('back' to go back): ";
    getline(cin, dest);
...
void fastestRoundTrip()
{
    ...
    cin.ignore();
B:
    cout << "Round-trip (Fastest): Enter starting station ('back' to go back): ";
    string org;
    getline(cin, src);
    org = src;
    bool digit = true;
...
C:
    cout << "Round-trip (Fastest): Enter destination station ('back' to go back): ";
    getline(cin, dest);
